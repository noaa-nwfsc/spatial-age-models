...
Estimates of age composition by year may be useful in tracking the distribution of cohorts through time, as well as examining variability in distributions of particular age classes over time. For example, results from our models can be used to project the spatial distributions of strong hake cohorts (2010, 2014, 2016; @fig-hake-spatial-composition) and strong sablefish cohorts (2008, 2010, 2016, 2021, @fig-sablefish-spatial-composition). These predictions are also useful in revealing subtle differences between strong cohort years. For example, the 2014 cohort of Pacific hake had a larger fraction of age-1 individuals distributed in the northern part of the domain (along the coast of Washington state), while other cohorts had hotspots in the center and southern portion of the domain. Similarly for sablefish, the 2010 cohort also appeared to be more concentrated in the north (age-1 individuals in 2011), versus other cohorts that had a more coastwide distribution.
...
```{r label="fig-hake-spatial-composition", fig.cap="Estimated spatial catch per unit effort (CPUE, kg per km2) for Pacific hake; rows represent strong cohorts in our dataset (2010, 2014, 2016). CPUE is standardized to 1.0 across cohorts for visualization purposes. Full predictions for all cohorts are in the Supplementary Information.", echo=FALSE}
knitr::include_graphics("plots/Map-Pacific hake-age-class.png")
```
...
knitr::include_graphics("plots/Map-sablefish-age-class.png")
```
...
knitr::include_graphics("plots/Map-Pacific hake-year.png")
```
...
knitr::include_graphics("plots/Map-sablefish-year.png")
```
